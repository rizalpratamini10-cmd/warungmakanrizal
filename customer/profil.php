...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($_POST['password'])) {
        ...
        $koneksi->query("UPDATE users SET nama_lengkap = '$nama', no_hp = '$no_hp', alamat = '$alamat', password = '$password' WHERE id = $customer_id");
    } else {
        $koneksi->query("UPDATE users SET nama_lengkap = '$nama', no_hp = '$no_hp', alamat = '$alamat' WHERE id = $customer_id");
    }
    
    // Update session
    $_SESSION['customer_nama'] = $nama;
    $_SESSION['customer_no_hp'] = $no_hp;
    $_SESSION['customer_alamat'] = $alamat;
...
<head>
    ...
    <title>Profil Saya - Warung Makan Rizal</title>
                        ...
                        <div class="col-md-4">
                            <div class="card shadow-sm text-center">
                                <div class="card-body">
                                    ...
                                    <h5><?php echo $customer['nama_lengkap']; ?></h5>
                                ...
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="alamat" class="form-control" rows="3" required><?php echo $customer['alamat']; ?></textarea>
                                        </div>
                                        <div class="mb-3">
